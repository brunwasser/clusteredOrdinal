...
* Refit the model accounting for non-independence due to clustering within families using the *coeftest()* function from **lmtest** package in conjunction with the **sandwich** package functions *vcovCL()* 
